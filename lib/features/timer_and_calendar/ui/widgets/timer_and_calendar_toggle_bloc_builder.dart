...
class TimerAndCalendarToggleBlocBuilder extends StatelessWidget {
  const TimerAndCalendarToggleBlocBuilder({
    super.key,
    required this.calendarRowBlocBuilder,
  });

  final Widget calendarRowBlocBuilder;
        ...
        return Column(
          children: [
            ...
            getTimerAndCalendarChild(
              cubit: cubit,
              state: state,
              calendarRowBlocBuilder: calendarRowBlocBuilder,
            ),
          ],
        );
      },
...
Widget getTimerAndCalendarChild({
  ...
  required Widget calendarRowBlocBuilder,
}) {
  if (state is CalendarModeState) {
    return calendarRowBlocBuilder;
